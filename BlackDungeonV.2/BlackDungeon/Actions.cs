    ...
    */
    class Actions
    {
        ...
        private void MoveAction() {
            ...
            else if (direction == "CENTER" && roomMachine.GetNeighboors().Contains(roomMachine.GetRoomByName("CENTER"))) {
                roomMachine.MakeTransitionTo(roomMachine.GetRoomByName("CENTER"));
            }           
            else
            {
                Console.WriteLine(" This is not a valid exit ");
